...
# キーの順序が異なるとハッシュの生成値が異なるため、順序を揃える必要がある
...
def find_neighbours(my_host, my_port, start_ip_range, end_ip_range, start_port, end_port):
    ...
    for guess_port in range(start_port, end_port):
        for ip_range in range(start_ip_range, end_ip_range):
            guess_host = f'{prefix_host}{ip_range}'
...
if __name__ == '__main__':
    print(get_host())
    # print(is_found_host('172.18.0.2', 8080))
    # print(is_found_host('172.18.0.2', 5000))
    # print(is_found_host('192.168.0.4', 5000))
    # print(is_found_host('127.0.0.1', 5000))
    # print(find_neighbours('172.18.0.2', 5000, 0, 3, 5000, 5003))
    # print(find_neighbours('192.168.0.4', 5000, 0, 3, 5000, 5003))
